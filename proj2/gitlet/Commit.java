...
public class Commit implements Serializable {
    ...
    private Map<String, String> pathToBlobID = new HashMap<>();//每个commit中的所有blob文件,key为filepath，value为文件的sha1 id

    private List<String> parents;//历史commit信息

    private Date currentTime;//提交时间

    private String id;//commit的sha1

    private File commitSaveFileName;//commit的持久化存储
